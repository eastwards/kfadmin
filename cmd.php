...
define('ResourceDir', CmdDir.'/Resource');
define('AppDir', CmdDir.'/App');
define('DataDir', CmdDir.'/Data');
define('ConfigDir', CmdDir.'/Config');
define('ActionDir', $CmdDir.'/App/Console');				//定义控制器存放路径
